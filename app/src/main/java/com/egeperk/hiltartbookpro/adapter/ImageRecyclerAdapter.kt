...
class ImageRecyclerAdapter @Inject constructor(val glide: RequestManager) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.search_image_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ImageViewHolder, position: Int) {
        val imageView = holder.itemView.findViewById<ImageView>(R.id.search_row_imageView)
